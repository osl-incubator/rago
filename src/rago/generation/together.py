...
class TogetherGen(GenerationBase):
    ...
    def _setup(self) -> None:
        ...
        #if we have to get structured output instructor uses doesn't have support for together yet
        #but we can access the model and use openai sdk if we need to get structured output
